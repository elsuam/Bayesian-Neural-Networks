...
\usepackage{verbatim}
\usepackage[width=.75\textwidth]{caption} %global adjustment to captions
...
\title{An Introduction to Neural Networks and the Deployment of  \\

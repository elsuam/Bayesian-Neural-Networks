...
\includegraphics[width =.6\linewidth]
{earthquakes_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics[width =.6\linewidth]
{earthquakes_files/figure-latex/unnamed-chunk-13-2.pdf}
...
%this one I am just pretending is the same as the model above, since when I knit the file it did not catch an outlier.
\includegraphics[width =.6\linewidth]{Figures/tohoku.png}
%{earthquakes_files/figure-latex/unnamed-chunk-13-3.pdf}

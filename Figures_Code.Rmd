...
for (i in 1:samplesize){
  good <- 0:100 #Denotes a good observation
  bad <- 100:0  #Denotes a bad observation
  #  if(i %% 10==0){                    #for every 10th sample (when activated and sample size is increased)
    ...
    dat <- data.frame(x=0:100, y=y/max(y), col=rep(i:i, each=101)) #normalize y and place values into a data frame

...
a local minimum of a function.  Figure \ref{red} appears to have a local minimum somewhere around approximately $x = 4$ In a simple case below, given the function \(f(x) = \frac{x^3}{2} - x^2 - 12x\), a local minimum is found by differentiating the function and finding the correct turning points in which the slope is zero. 
